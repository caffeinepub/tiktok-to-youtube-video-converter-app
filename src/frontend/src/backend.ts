...
export class Backend implements backendInterface {
    ...
    async addConversion(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addConversion(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getConversionHistory(): Promise<Array<ConversionEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getConversionHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
